...
import { getBoundingBox, interpolatePath } from "@remotion/paths";
...
export const MyComposition: React.FC<z.infer<typeof myCompSchema>> = () => {
  ...
  const bounding = getBoundingBox(interpolated);

  return (
    <AbsoluteFill className="bg-gray-100 items-center justify-center">
      <svg viewBox={`0 0 ${bounding.width} ${bounding.height }`} style={{
